...
//Route::get('product-track', [ProductTrackController::class])->name('product-track');
...
//     //search payment
//     Route::get('/bkash/search/{trxID}', [App\Http\Controllers\BkashTokenizePaymentController::class,'searchTnx'])->name('bkash-search');
