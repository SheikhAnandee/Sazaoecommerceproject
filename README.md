# "Sazao"-multi-vendor e-commerce platform

# Background
The project’s specifications includes order processing, advanced search capabilities, shopping cart
functionality, product reviews, and user and product administration.
I used PHP for server-side scripting and laravel framework for the backend,with SQL
Server as the database. For the frontend, I applied HTML, CSS, JavaScript, Bootstrap,
