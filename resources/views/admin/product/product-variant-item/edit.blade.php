            ...
            <div class="card-body">
              ...
              @method('PUT')
                <div class="form group">
                  ...
                  <input type="text" class="form-control" name="variant_name" value="{{$variantItem->productVariant->name}}" readonly></input>
                 </div>

              
                 <div class="form group">
                  <label>Item name</label>
                  <input type="text" class="form-control" name="name" value="{{$variantItem->name}}"></input>
                 </div>
                 <div class="form group">
                  <label>Price<code>(Set 0 for make it free)</code></label>
                  <input type="text" class="form-control" name="price"value="{{$variantItem->price}}"></input>
                 </div>
