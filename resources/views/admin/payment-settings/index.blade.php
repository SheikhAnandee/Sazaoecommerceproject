                      ...
                      <div class="row">
                        <div class="col-2">
                          <div class="list-group" id="list-tab" role="tablist">
                            ...
                            <a class="list-group-item list-group-item-action" id="list-bkash-list" data-toggle="list" href="#list-bkash" role="tab">Bkash</a>
                        ...
                        <div class="col-10">
                          <div class="tab-content" id="nav-tabContent">
                            ...
                            @include('admin.payment-settings.sections.bkash-setting')
