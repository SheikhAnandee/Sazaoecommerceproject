            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="wsus__single_banner_content ">
                            ...
                            <div class="wsus__single_banner_img"style="background-image: url('{{ asset($cartpage_banner_section->banner_one->banner_image) }}'); background-size: cover; background-position: center;">
                            </div>
                            @endif
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="wsus__single_banner_content single_banner_2">
                        ...
                        <div class="wsus__single_banner_img"style="background-image: url('{{ asset($cartpage_banner_section->banner_two->banner_image) }}'); background-size: cover; background-position: center;">
                        </div>
                        @endif
                        <div class="wsus__single_banner_text">
