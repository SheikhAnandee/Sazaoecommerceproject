<section id="wsus__large_banner">
    <div class="container">
        <div class="row">
            <div class="cl-xl-12">
                <div class="wsus__large_banner_content" style="background: url({{ asset($homepage_section_banner_four->banner_one->banner_image) }});">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-md-6">
                                <div class="wsus__large_banner_text wsus__large_banner_text_right">
                                    ...
                                    <a class="shop_btn" href="{{$homepage_section_banner_four->banner_one->banner_url}}">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
