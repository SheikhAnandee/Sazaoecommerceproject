                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="wsus__single_banner_content banner_1">
                            <div class="wsus__hot_deals_img" style="background-image: url('{{ asset($homepage_section_banner_three->banner_one->banner_image )}}'); background-size: cover; background-position: center;">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="wsus__single_banner_content single_banner_2">
                                 <div class="wsus__single_banner_img"style="background-image: url('{{ asset($homepage_section_banner_three->banner_two->banner_image )}}'); background-size: cover; background-position: center;">
                                </div>
                                    <div class="wsus__single_banner_text">
                            ...
                            <div class="col-12 mt-lg-4">
                                <div class="wsus__single_banner_content">
                                    <div class="wsus__single_banner_img"style="background-image: url('{{ asset($homepage_section_banner_three->banner_three->banner_image )}}'); background-size: cover; background-position: center;">
                                    </div>
                                    <div class="wsus__single_banner_text">
