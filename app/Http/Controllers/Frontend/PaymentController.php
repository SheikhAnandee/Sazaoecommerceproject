...
//       $total = getFinalPayableAmount();
//       $payableAmount = round($total * $bkashSetting->currency_rate, 2);

//       Stripe::setApiKey($bkashSetting->secret_key);
//      $response = Charge::create([
//           "amount" => $payableAmount * 100,
//           "currency" => $bkashSetting->currency_name,
//           "source" => $request->bkash_token,
//           "description" => "product purchase!"
//       ]);
  
//       if($response->status === 'succeeded'){
//           $this->storeOrder('bkash', 1, $response->id, $payableAmount, $bkashSetting->currency_name);
//           // clear session
//           $this->clearSession();
